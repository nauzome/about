    ...
    return (
        <div class="nav">
            ...
            <ul>
                ...
                <li><Link href="/en/avatar">avatar</Link></li>
                <li><Link href="/en/donation">Donation</Link></li>
                <li><Link href="/en/afctivity">afctivity</Link></li>
                <li><Link href="/en/ethics">ethics</Link></li>
                <li><Link href="/en/history">history</Link></li>
                <li><Link href="/en/license">license</Link></li>
