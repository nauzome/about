...
export default function Home() {
  return (
    <>
      <div className="grid gap-5 lg:py-5 lg:px-4 lg:border-2 border-slate-300 border-2 border-slate-300 dark:border-slate-500 lg:border-solid w-full">
        <h2 className="text-3xl">なうぞめの歴史</h2>

        <div className="grid gap-2 lg:grid-cols-2">
          <div className="p-4 bg-blue-100 dark:bg-gray-800 ">
