        ...
        <div className="my-3">
          <div className="relative w-full aspect-video my-4 bg-maxblue overflow-hidden">
            <div className="absolute inset-0 w-full h-full">
              <Image
                src="/a5fdad9de7faf3a0492812b9cb818d85.webp"
                width="1500"
                height="1500"
                alt=""
            ...
            <div className="absolute inset-0 flex items-center w-full h-full">
              <h2 className="px-4 text-5xl md:text-8xl text-white">Faq</h2>
            </div>
          </div>{" "}
          <p>
            なんか質問が無いので自分で質問します。なんか動画投稿者がやっていました。
          </p>
          <div className="max-w-max bg-blue-100 dark:bg-gray-800 my-4">
            <div className="p-4 border-2 border-blue-500 dark:border-slate-500 border-solid">
              <ul className="list-decimal list-inside text-blue-700 dark:text-blue-400">
                <li>
          ...
          <div className="my-4" id="安全なメッセンジャーは？">
          ...
          <div className="my-4" id="猫派犬派">
            <h3 className="text-xl">猫派犬派</h3>
            <p>可愛いよねぇー(回答になっていない。)。</p>
          </div>
          <div className="my-4" id="好きな配信者、動画投稿者は？">
          ...
          <div className="my-4" id="好きなスープは？">
            <h3 className="text-xl">好きなスープは？</h3>
            <p>コーンスープです。</p>
          </div>
          <div className="my-4" id="資格は？">
            <h3 className="text-xl">資格は？</h3>
            <p>無い。</p>
          </div>
          <div className="my-4" id="一緒にいて楽しい人は">
            <h3 className="text-xl">一緒にいて楽しい人は</h3>
            <p>食べ物を美味しいという人。</p>
          </div>
          <div className="my-4" id="最近あった嬉しかったことは">
            <h3 className="text-xl">最近あった嬉しかったことは</h3>
            <p>髪の毛の色を褒められた。</p>
          </div>
          <div className="my-4" id="好きなソフトウェア">
          ...
          <div className="my-4" id="技術者ですか">
            <h3 className="text-xl">技術者ですか</h3>
            <p>はい。</p>
          </div>
          <div className="my-4" id="好きなライセンスは？">
          ...
          <div className="my-4" id="欲しいもの">
            <h3 className="text-xl">欲しいもの</h3>
            <p>語彙力、読解力？</p>
          </div>
          <div className="my-4" id="今聴いている曲は？">
